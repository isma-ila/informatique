            ...
            while w != self.__liveController_o.get_height() / self.__liveController_o.get_c():
                ...
                if x == 0 and y == 0:
                    ...
                    if self.get_dico_case[
                        x + self.__liveController_o.get_c(), y + self.__liveController_o.get_c()] == 1:
                        compt_viv += 1
                    self.get_dico_etat[x, y] = compt_viv
                # coin en bas à gauche
                elif x == 0 and y == int(self.__liveController_o.get_height() - self.__liveController_o.get_c()):
                    compt_viv = 0
                    if self.get_dico_case[x, y - self.__liveController_o.get_c()] == 1:
                        compt_viv += 1
                    if self.get_dico_case[
                ...
                # coin en haut à droite
                elif x == int(self.__liveController_o.get_width() - self.__liveController_o.get_c()) and y == 0:
                    compt_viv = 0
                    if self.get_dico_case[x - self.__liveController_o.get_c(), y] == 1:
                        compt_viv += 1
                    if self.get_dico_case[
                    ...
                    if self.get_dico_case[x, y + self.__liveController_o.get_c()] == 1:
                        compt_viv += 1
                    self.get_dico_etat[x, y] = compt_viv
                elif x == int(self.__liveController_o.get_width() - self.__liveController_o.get_c()) and y == int(
                        self.__liveController_o.get_height() - self.__liveController_o.get_c()):  # coin en bas à droite
                    compt_viv = 0
                    if self.get_dico_case[
                        x - self.__liveController_o.get_c(), y - self.__liveController_o.get_c()] == 1:
                        compt_viv += 1
                ...
                # bord de gauche
                elif x == 0 and 0 < y < int(self.__liveController_o.get_height() - self.__liveController_o.get_c()):
                    compt_viv = 0
                    if self.get_dico_case[x, y - self.__liveController_o.get_c()] == 1:
                        compt_viv += 1
                    if self.get_dico_case[x, y + self.__liveController_o.get_c()] == 1:
                    ...
                    self.get_dico_etat[x, y] = compt_viv
                # bord de droite
                elif x == int(self.__liveController_o.get_width() - self.__liveController_o.get_c()) and 0 < y < int(
                        self.__liveController_o.get_height() - self.__liveController_o.get_c()):
                    compt_viv = 0
                    if self.get_dico_case[
                        x - self.__liveController_o.get_c(), y - self.__liveController_o.get_c()] == 1:
                        compt_viv += 1
                    ...
                    self.get_dico_etat[x, y] = compt_viv
                # bord du haut
                elif 0 < x < int(self.__liveController_o.get_width() - self.__liveController_o.get_c()) and y == 0:
                    compt_viv = 0
                    if self.get_dico_case[x - self.__liveController_o.get_c(), y] == 1:
                        compt_viv += 1
                    if self.get_dico_case[
                    ...
                    self.get_dico_etat[x, y] = compt_viv
                # bord du bas
                elif 0 < x < int(self.__liveController_o.get_width() - self.__liveController_o.get_c()) and y == int(
                        self.__liveController_o.get_height() - self.__liveController_o.get_c()):
                    compt_viv = 0
                    if self.get_dico_case[
                        x - self.__liveController_o.get_c(), y - self.__liveController_o.get_c()] == 1:
        ...
        while t != self.__liveController_o.get_width() / self.__liveController_o.get_c():
            ...
            while u != self.__liveController_o.get_height() / self.__liveController_o.get_c():
                ...
                if self.get_dico_etat[x, y] == 3:
                    ...
                    self.__can1.create_rectangle(x, y, x + self.__liveController_o.get_c(),
                                                 y + self.__liveController_o.get_c(), fill='black')
                    ...
                    if self.get_dico_etat[x, y] == 1:
                        ...
                        self.__can1.create_rectangle(x, y, x + self.__liveController_o.get_c(),
                                                     y + self.__liveController_o.get_c(), fill='white')
